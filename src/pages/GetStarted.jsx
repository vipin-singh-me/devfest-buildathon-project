...
const StepCard = ({ number, title, desc, ctaText, ctaTo, accent = "bg-blue-600" }) => (
  <div className="bg-white rounded-2xl shadow-md p-5 flex flex-col gap-4 hover:shadow-xl transition">
    <div className="flex items-center gap-3">
      <div className={`flex items-center justify-center w-10 h-10 rounded-full text-white font-semibold ${accent}`}>
        {number}
      </div>
    ...
    {ctaTo && (
      <Link
        to={ctaTo}
        className="self-start mt-2 inline-block px-4 py-2 rounded-lg bg-transparent border border-gray-200 text-sm font-medium hover:bg-gray-50"
      >
        {ctaText}
      </Link>
    )}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <header className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8 shadow-sm">
          <div>
            ...
            <p className="text-gray-600 mt-2 max-w-xl">
              Quick setup to get you hacking fast. Create your profile, find teammates, match, and launch your project — all in a few minutes.
            </p>
          </div>
        ...
        <main className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <section className="lg:col-span-2 space-y-6">
            ...
            {/* sample team idea cards */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-gradient-to-r from-white to-gray-50 rounded-2xl p-5 shadow-sm hover:shadow-md transition">
                <div className="flex items-center justify-between">
                  <h4 className="font-semibold text-gray-800">Sample Idea — Community Map</h4>
                  <span className="text-sm text-gray-500">3–4 devs</span>
                </div>
                <p className="text-sm text-gray-600 mt-2">Find local events and allow RSVPs — frontend + maps + backend.</p>
                <div className="mt-3 flex gap-2">
                  <Link to="/create-team" className="text-sm px-3 py-1 rounded-md bg-blue-50 text-blue-600">Join</Link>
                  <Link to="/how-it-works" className="text-sm px-3 py-1 rounded-md border">Details</Link>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-white to-gray-50 rounded-2xl p-5 shadow-sm hover:shadow-md transition">
                ...
                <p className="text-sm text-gray-600 mt-2">Build a public appreciation wall with badges and leaderboard.</p>
                <div className="mt-3 flex gap-2">
                  <Link to="/create-team" className="text-sm px-3 py-1 rounded-md bg-blue-50 text-blue-600">Join</Link>
                  <Link to="/how-it-works" className="text-sm px-3 py-1 rounded-md border">Details</Link>
                </div>
          ...
          <aside className="space-y-4">
            <div className="sticky top-6">
              <div className="bg-white rounded-xl p-4 shadow-sm">
                ...
                <div className="mt-4 space-y-3">
                  <Resource
                    icon={
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3-1.343-3-3S10.343 2 12 2s3 1.343 3 3-1.343 3-3 3zM5.5 21h13a2 2 0 002-2v-1a4 4 0 00-4-4H7.5a4 4 0 00-4 4v1a2 2 0 002 2z" />
                      </svg>
                    }
                  ...
                  <Resource
                    icon={
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-3.866 0-7 2.91-7 6.5S8.134 21 12 21s7-2.91 7-6.5S15.866 8 12 8z" />
                      </svg>
                    }
                    title="GitHub Template"
                    desc="Use a starter repo to speed up development (README, CI, and deploy)."
                  ...
                  <Resource
                    ...
                    title="Pro tip"
                    desc="Commit small frequent changes and keep your README clear for judges."
                    linkText="Read tips"
                    to="/tips"
                  />
                </div>
              ...
              <div className="mt-4 bg-white rounded-xl p-4 shadow-sm">
                ...
                <p className="text-sm text-gray-500 mt-2">Track how ready you are for the hackathon.</p>
